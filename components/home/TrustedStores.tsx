...
export function BrandLogoStrip({ brands, variant = "section" }: BrandLogoStripProps) {
  ...
  const brandNames = brands.length > 0 ? brands : FALLBACK_BRANDS;
      ...
      >
        <div className="trusted-stores-track">
          {marqueeBrands.map((brand, index) => (
            ...
            >
              <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-[#dfcfbc] bg-[#f7efe3] font-display text-[0.9rem] leading-none text-[#1E4B3B]">
