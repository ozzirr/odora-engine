...
const TOPIC_POOL_IT: Topic[] = [
  { title: "I migliori profumi legnosi per l'autunno", primaryKeyword: "profumi legnosi uomo donna", secondaryKeywords: ["fragranze woody autunno", "note di sandalo cedro", "profumi legnosi 2025"], tags: ["legnoso", "autunno", "guida"] },
  ...
  { title: "I migliori profumi floreali per la primavera", primaryKeyword: "profumi floreali donna primavera", secondaryKeywords: ["fragranze floreali 2025", "profumi con note di rosa peonia", "migliori profumi primaverili"], tags: ["floreale", "primavera", "donna"] },
  ...
  { title: "Profumi unisex: i migliori da condividere", primaryKeyword: "profumi unisex migliori", secondaryKeywords: ["fragranze unisex 2025", "profumo per lui e lei", "profumi gender neutral"], tags: ["unisex", "guida", "coppia"] },
  ...
  { title: "Profumi con note di vaniglia: caldi, avvolgenti, iconici", primaryKeyword: "profumi vaniglia migliori", secondaryKeywords: ["fragranze con vaniglia", "profumi caldi vaniglia 2025", "profumo vaniglia uomo donna"], tags: ["vaniglia", "gourmand", "caldo"] },
  ...
  { title: "Profumi di nicchia italiani: eccellenze da scoprire", primaryKeyword: "profumi niche italiani", secondaryKeywords: ["profumeria artistica italiana", "niche italiani 2025", "brand profumi italiani"], tags: ["italiano", "niche", "lusso"] },
  ...
  { title: "I migliori profumi da uomo per ogni stagione", primaryKeyword: "migliori profumi uomo 2025", secondaryKeywords: ["profumo uomo primavera estate autunno inverno", "profumi maschili consigliati", "top profumi uomo"], tags: ["uomo", "guida", "stagionale"] },
];

const TOPIC_POOL_EN: Topic[] = [
  { title: "The best woody fragrances for autumn", primaryKeyword: "best woody fragrances men women", secondaryKeywords: ["woody autumn fragrances", "sandalwood cedar notes perfume", "woody fragrances 2025"], tags: ["woody", "autumn", "guide"] },
  ...
  { title: "Gourmand fragrances: sweet, sensual and irresistible", primaryKeyword: "best gourmand fragrances vanilla", secondaryKeywords: ["sweet fragrances women", "vanilla perfumes 2025", "gourmand perfume meaning"], tags: ["gourmand", "vanilla", "sweet"] },
  { title: "Summer fragrances: fresh, citrusy and luminous", primaryKeyword: "best summer fragrances 2025", secondaryKeywords: ["fresh citrus perfumes summer", "light fragrances hot weather", "best perfumes for summer"], tags: ["summer", "fresh", "citrus"] },
  ...
  { title: "The best floral fragrances for spring", primaryKeyword: "best floral fragrances women spring", secondaryKeywords: ["spring floral perfumes 2025", "rose peony perfumes", "light floral fragrances"], tags: ["floral", "spring", "women"] },
  ...
  { title: "Unisex fragrances: the best to share", primaryKeyword: "best unisex fragrances 2025", secondaryKeywords: ["gender neutral perfumes", "unisex fragrance for couples", "top unisex scents"], tags: ["unisex", "guide", "couples"] },
  ...
  { title: "Vanilla fragrances: warm, enveloping and iconic", primaryKeyword: "best vanilla fragrances 2025", secondaryKeywords: ["vanilla perfumes men women", "warm vanilla scents", "gourmand vanilla fragrance"], tags: ["vanilla", "gourmand", "warm"] },
  { title: "How to choose a fragrance for cold weather", primaryKeyword: "best winter fragrances 2025", secondaryKeywords: ["autumn winter perfumes men women", "warm cozy fragrances", "best cold weather perfumes"], tags: ["winter", "guide", "seasonal"] },
  ...
  { title: "Musky fragrances: clean, sensual and versatile", primaryKeyword: "best musky fragrances 2025", secondaryKeywords: ["white musk perfumes", "clean musk fragrance notes", "versatile musk scents"], tags: ["musk", "clean", "versatile"] },
  ...
  { title: "Spicy fragrances: bold, warm and unforgettable", primaryKeyword: "best spicy fragrances 2025", secondaryKeywords: ["pepper cardamom perfumes men", "warm spicy scents women", "bold spicy fragrances"], tags: ["spicy", "bold", "warm"] },
